...
// **【目視必須札】(AZ3 で裁定・2026-09-13)**: 機械化できない。書込権限の無い**ログイン済み**利用者が要り、
// 検証ハーネスは未ログインでしか叩けない (認証情報をリポジトリにもハーネスにも置かない方針)。
// ∴ 「fork 導線が出る」は**測定述語に翻訳せず札のまま残す**。実アカウントで確認できた時点で
// この札を外し、代わりに観測結果をここへ書くこと (札の数が減ること自体が境界が動いた証拠・CI-14)。
// ---------------------------------------------------------------------------------
